...
class TestStandbyReturnEquipmentIdRead(TestCase):

    def setUp(self):
        self.state = state.StandbyReturnEquipmentIdRead()
    ...
    def test_exit_by_key(self):
        ...
        state.CommonResource.prev_state = state.StandbyUserProcedureInput()
